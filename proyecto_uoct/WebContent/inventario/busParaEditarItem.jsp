 ...
 out.print("<strong><font color=\"red\">"+mensaje+"</font></strong>");}
  ...
  <tr>
    <td><form action="inventarioAction.do" method="POST" name="busItemForm">
        <input type="hidden" name="accion" value="buscarParaEditarItem" />
        <table width="358" border="1">
          <tr>
            <td width="23%" bgcolor="#F7FBC4"> <div align="right"><strong>Categor&iacute;a</strong></div></td>
            <td width="77%">
...
%>
        <display:table name="listaitems" requestURI="inventarioAction.do" class="its">
        <display:caption>Items encontrados</display:caption>
        <display:column title="IDItem" property="idItem" sortable="true">
        </display:column>
        <display:column title="Nombre" property="nomItem" maxLength="40">
        </display:column>
        <display:column title="Categoría" property="nomCategoria" maxLength="30" sortable="true">
        </display:column>
        <display:column title="Cantidad" property="cantidadItem">
        </display:column>
        <display:column title="Editar" media="html" href="inventarioAction.do?accion=editarItem" paramId="idItem" paramProperty="idItem">

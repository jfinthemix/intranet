...
<%@page import="java.util.List, java.util.Iterator,proyecto_uoct.infoyrep.VO.ReportajeVO" %>
...
<html>
<head>
<title>Seleccionar Reportaje para Actualizar</title>
...
<body>
<h3>Seleccionar Reportaje para Actualizar</h3>
<table width="590" border="0">
  ...
  request.setAttribute("lista",lis);%>
        ...
        <display:column title="Reportaje" href="reportAction.do?hacia=aactualizarReportaje" maxWords="10" paramId="idRep" paramProperty="idRep"> <%=((ReportajeVO)reportaje).getTitRep() %> </display:column>

...
<table  border="0" align="left">
  ...
  request.setAttribute("lista",lis);%>
        ...
        <display:column style="tablaAncha" class="texto1"  title="Reportajes anteriores" href="reportAction.do?hacia=detReportaje" maxWords="13" paramId="idRep" paramProperty="idRep">  <img alt="" src="../util/img/news1.gif" border="0"/> <%=((ReportajeVO)reportaje).getTitRep() %> </display:column>

...
<table width="779" border="0">
  <tr> 
    <td width="773"><h3 align="center">Buscar Documentos</h3></td>
  </tr>
  <tr> 
    <td> <div align="center"> 
      ...
      <form action="documentoAction.do" name="buscarDocs">
        <div align="center"> 
          <input type="hidden" name="hacia" value="buscarDocs_pop"/>
          <table width="463" border="1" align="center">
            <tr bgcolor="#F7FBC4"> 
              <td width="31%" bgcolor="#FAA564"> 
                <label> 
                <input name="tipoBus" type="radio" value="1" checked onclick="deshabilitaEnIni();">
                </label> <strong>Por c&oacute;digo</strong> </td>
...
<input type="radio" name="tipoBus" value="2" onclick="habilitaEnIni();"> 
            ...
            <tr> 
              <td width="31%" bgcolor="#ADD8E4"><div align="right"><strong>Materia</strong></div></td>
              <td colspan="2"> <input type="text" name="materia"> </td>
            </tr>
            <tr> 
              <td rowspan="2" bgcolor="#ADD8E4"><div align="right"><strong>Fecha</strong></div></td>
              <td width="9%" height="28">Desde:</td>
              <td width="60%"> <input type="Text" name="fecha_ini" readonly> <a href="javascript:cal1.popup();"> 

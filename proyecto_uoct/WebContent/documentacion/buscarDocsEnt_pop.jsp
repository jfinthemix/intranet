...
<table width="750" border="0">
  <tr>
    <td><div align="center">
        <h3>Buscar Documentos Entrantes</h3>
      </div></td>
  </tr>
  <tr>
    <td><div align="center">
        <% if (mensaje!=null){out.println(mensaje);} %></div>
        </div>
      <form action="documentoAction.do" name="buscarDocs">
        <div align="center">
          <input type="hidden" name="hacia" value="buscarDocsEnt_pop"/>
          <table width="428" border="1" align="center">
            <tr bgcolor="#F7FBC4">
              <td width="39%" bgcolor="#FAA564"> 
                <label>
                <input name="tipoBus" type="radio" value="1" onclick="deshabilitaEnIni();">
            ...
            <tr bgcolor="#33FF00">
              <td width="39%" bgcolor="#FAA564">
<input name="tipoBus" type="radio" onclick="habilitaEnIni();" value="2" checked>
            ...
            <tr>
              <td width="39%" bgcolor="#ADD8E4"><div align="right"><strong>Materia</strong></div></td>

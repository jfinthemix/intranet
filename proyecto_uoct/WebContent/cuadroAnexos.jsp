...
<body >
  ...
  <display:table requestURI="index2Action.do" name="anexoses" id="anexs" class="table table-striped table-bordered table-hover tablesorter">
						...
						<h2>Anexos telefónicos</h2>
				 		...
				 		<div class="box">
				 			...
				 			<table class="table table-striped table-bordered table-hover tablesorter">
      						<thead>
        							<tr>
          							<th><a href="javascript:void(0)">Nombre del anexo</a></th>
          							<th>Anexo</th>
          						</tr>
      						</thead>
      						<tbody>
        							...
        							<tr>
          							<td>Sala de reuniones 2° piso B</td>
          							<td>833</td>
          						</tr>
        							<tr>
          							<td>DataCenter</td>

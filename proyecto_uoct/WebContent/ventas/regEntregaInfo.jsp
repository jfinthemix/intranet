...
return false;
 ...
 resp=window.confirm('Al registrar la fecha de entrega de la información\n la venta pasará al estado\n INFORMACIÓN ENTREGADA.\n¿Desea continuar?');
...
<table width="750" border="0">
  <tr>
    <td colspan="2"><h3>Registrar Fecha de Entrega de la Información en Venta:
  ...
  <form action="ventasAction.do" method="POST" name="form1">
    ...
    <tr>
      <td width="239" bgcolor="#ADD8E4"><font color="#FF0000"><strong>Fecha de
        Entrega de la Información</strong>: </font> </td>

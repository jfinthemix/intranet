...
<table width="750" border="0">
  <tr>
    <td height="22">
<h3>Buscar Ventas para editar</h3></td>
  </tr>
<form method="post" action="ventasAction.do" name="form1">
  <tr>
    <td>  <input type="hidden" name="accion" value="buscarParaEditarVta" />
	<table width="440" border="1" align="left">
          ...
          <td width="278"> <table width="246" border="0">
              <tr>
                <td width="77" bgcolor="#FFFF00"> <div align="right">Entre el:</div></td>
              ...
              <tr>
                <td bgcolor="#FFFF00"> <div align="right">y el:</div></td>
...
//-->
          ...
          <%if(ventas!=null){%>
          <display:table class="its" name="ventas" id="vs" defaultorder="ascending" defaultsort="1" requestURI="ventasAction.do">
		  ...
		  <display:column title="Fecha de Inicio"><%=sdf.format(((VtaVO)vs).getFechaRecepcion()) %> </display:column>
                  ...
                  <display:column title="Estado" property="estado" sortable="true" sortProperty="estado"></display:column>
                  <display:column title="Editar Venta">
          <%if(((VtaVO)vs).getIdEstado().intValue()!=5 && ((VtaVO)vs).getIdEstado().intValue()!=6){%>
          <a href="ventasAction.do?accion=editarVenta&idVenta=<%=((VtaVO)vs).getIdVenta()%>">Editar</a>
          <%}else{%>
          Venta no editable
          <% }%>

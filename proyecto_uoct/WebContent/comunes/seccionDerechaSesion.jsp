...
DatosSesVO DatosSesion= (DatosSesVO)request.getAttribute("DatosUsu");
...
%>
					...
					<div class="media profile">
							<div class="media-left">
  							...
  							<div class="media-body">
  								<p>Has ingresado como: <strong id="userName"><%=DatosSesion.getNom()+" "+DatosSesion.getAp()%></strong></p>
  								<a id="aLogout" class="botoNegro" href="indexAction.do?hacia=signout" alt="Cerrar sesión"><span class="glyphicon glyphicon-log-out"></span> Cerrar sesión</a>
  							</div>
						</div>

  ...
  <tr>
    <td><div align="center">
        <table width="444" border="1" align="center">
          <tr>
            <td width="192" bgcolor="#ADD8E4"><div align="right"><strong>EISTU
                No.:</strong></div></td>
...
%>
        <table width="636" border="1" align="center">
          <tr>
            <td width="149"><%= sdf.format(even.getFechaEv())%></td>
            <td width="259"><%=even.getTitulo()%></td>
            <td width="206">
          ...
          <tr>
            <td height="32"  bgcolor="#A6F7BA"> <div align="center"><strong>Descripci&oacute;n
                de Bit&aacute;cora</strong></div></td>
            <td colspan="2" bgcolor="#F7FBC4"><%=even.getDescEv() %></td>
          </tr>

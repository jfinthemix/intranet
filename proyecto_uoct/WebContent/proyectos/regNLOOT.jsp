...
<%@page import="proyecto_uoct.documentacion.VO.*,proyecto_uoct.proyecto.VO.DetalleProyectoVO,proyecto_uoct.proyecto.VO.DetalleOTVO"%>
...
DetalleOTVO detot=(DetalleOTVO)request.getAttribute("detOT");
...
<table width="750" border="0">
  <tr>
    <td><h3>Registro de NLO asociada a OT</h3></td>
  </tr>
  <tr>
    <td><input type="hidden" name="hacia" value="registrarNLO" /> <input type="hidden" name="idProy" value="<%=detproy.getIdProy() %>" />
      <table width="581" border="1" align="left">
        <!--DWLayoutTable-->
        <tr>
          <td width="170" height="23" bgcolor="#ADD8E4"><div align="right"><strong>Iniciativa
              asociada:*</strong></div></td>
          <td width="395"><%=detproy.getNomProy() %> <input type="hidden" name="idCli" value="<%=detproy.getIdCliente() %>" />
          </td>
        </tr>
        <tr>
          <td width="170" height="23" bgcolor="#ADD8E4"><div align="right"><strong>OT asociada:*</strong></div></td>
          <td width="395"><%=detot.getNomOT() %> <input type="hidden" name="idOT" value="<%=detot.getIdOT() %>">
          </td>
        </tr>
        <tr>
          <td bgcolor="#ADD8E4"> <div align="right"><strong>Fecha de la NLO (**)*</strong>
            </div></td>
          <td> <div align="left">
        ...
        <tr>
          <td height="23" bgcolor="#ADD8E4"><div align="right"><strong>Descripci&oacute;n
              de la NLO:</strong></div></td>
          <td><textarea name="nota" cols="60" wrap="ON"></textarea></td>
        </tr>
      </table></td>
  </tr>
  <tr>
    <td>(**)Se registra como fecha de la NLO y del Documento.</td>
  </tr>
  <tr>
    <td><h4>Registro del Documento asociado</h4></td>
  </tr>
  <tr>
    <td><table width="630" border="1" align="left">
        <tr bgcolor="#CCCCCC">
          <td width="119"> <div align="right"> <strong> C&oacute;digo del Documento*
              </strong> </div></td>
          <td width="465"> <div align="left">
        ...
        <tr>
          ...
          <td> <table width="357" border="0">
              <tr>
                ...
                <td width="93"> <input type="button" value=" Agregar &gt;&gt;  "
        ...
        <tr>
          <td width="119" bgcolor="#ADD8E4"> <div align="right"><strong>Materia*:</strong>
            </div></td>
          <td> <div align="left">
        ...
        <tr>
          <td width="119" bgcolor="#ADD8E4"> <div align="right"><strong>Fecha
              de Recepción/Despacho *</strong> </div></td>
          <td> <div align="left">
              <input name="fecha_IO" type="Text" readonly size="15" >
              <a href="javascript:cal3.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Pincha aquí para seleccionar la fecha">
              </a> </div></td>
        </tr>
        <tr>
          <td width="119" bgcolor="#ADD8E4"> <p align="right"> <strong>Ant.:</strong>
            </p></td>
          <td> <div align="CENTER">
              <table width="102%" border="0">
                <tr>
                  <td width="53%" rowspan="2"> <input type="hidden" name="idDocAnt"/>
                  ...
                  <td width="27%" rowspan="2"> <select multiple="multiple" name="listaRel" size="3" >
                    </select> </td>
                </tr>
                <tr>
                  <td> <div align="center">
        ...
        <tr>
          <td width="119" bgcolor="#ADD8E4"> <div align="right"><strong>Resumen
        ...
        <tr>
          ...
          <td><table border="0">
              ...
              <tr>
                <td> <html:file property="eldoc2" disabled="true" onblur="valLargoFile(this.form.eldoc2)"/></td>
  ...
  <tr><td>** Solamente integrantes del equipo de trabajo de la iniciativa</td></tr>
  <tr>
    <td><input type="submit" value="Guardar" name="regNLOOT_submit" onClick="javascript:SelectAllList(document.form1.list1);"/></td>
  </tr>
</table>
...
<script language="JavaScript" type="text/javascript">
    ...
    frmvalidator.addValidation("idProy","req","Debe indicar la Iniciativa");
    ...
    frmvalidator.addValidation("fechaDoc","req","Debe indicar la fecha del Documento");

    frmvalidator.addValidation("fecha_IO","req","Debe indicar la fecha de Ingreso/Despacho del documento");

    frmvalidator.addValidation("nota","req","Debe indicar descripción de la NLO");
    frmvalidator.addValidation("nota","maxlen=500","Descripción de la NLO no puede superar los 500 caracteres");

    frmvalidator.addValidation("idTipoDoc","req");

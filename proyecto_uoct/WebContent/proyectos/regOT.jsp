...
List tiposDoc = (List) request.getAttribute("tiposDocOut");
Iterator ii=null;
List tiposDocIn = (List) request.getAttribute("tiposDocIn");
Iterator iTDIn=null;
...
if(tiposDoc!=null){
   ii = tiposDoc.iterator();
}
if(tiposDocIn!=null){
iTDIn=tiposDocIn.iterator();
}
String mensaje = null;
...
<table width="750" border="0">
  <tr>
    <td><h3>Ingreso de Orden de Trabajo </h3></td>
  </tr>
  <tr>
    <td><input type="hidden" name="hacia" value="registrarOT" /> <input type="hidden" name="idProy" value="<%=detproy.getIdProy() %>" />
      <table width="603" border="1" align="left">
        <!--DWLayoutTable-->
        <tr>
        ...
        <tr>
          ...
          <td> <table width="359" border="0">
              ...
              onClick="move(this.form.list2,this.form.list1)" name="B2"/> </td>
                <td width="184" rowspan="2"> <select multiple size="4" name="list1">
                  </select> </td>
              </tr>
              <tr>
        ...
        <tr>
          ...
          <td><font color="#FFFFFF">
            <input type="text" name="fechaOT" id="fechaOT2" size=12 readonly="readonly">
            <a href="javascript:cal1.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Seleccionar fecha">
            </a> </font> </td>
        </tr>
        <tr>
          <td bgcolor="#FF0000">
<div align="right"><font color="#FFFFFF"><strong>Plazo de Ejecuci&oacute;n:</strong></font></div></td>
          <td bgcolor="#FF0000"><font color="#FFFFFF">
            <input name="plazo" type="text" size="10">
            d&iacute;as</font> </td>
        </tr>
        <tr>
          <td bgcolor="#FF0000">
<div align="right"><font color="#FFFFFF"><strong>Fecha de Plazo
              de Ejecuci&oacute;n:</strong></font></div></td>
          <td bgcolor="#FF0000">
            <div align="left"> <font color="#FFFFFF">
              <input type="text" name="fecha_pejec" id="fecha_pejec2" size=12 readonly="readonly">
              <a href="javascript:cal2.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date">
              </a> </font></div></td>
        </tr>
        <tr>
          <td height="26" bgcolor="#ADD8E4"> <div align="right"><strong>Cobro
              EP:</strong></div></td>
          <td><input type="text" name="ep"></td>
        </tr>
        <tr>
          <td height="26" colspan="2">(*)La Fecha de la OT es registrada tambi&eacute;n
            como la Fecha de Documento.</td>
        </tr>
      </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width="600" border="1" align="left">
        <tr bgcolor="#CCCCCC">
          <td width="120"> <div align="right"> <strong> C&oacute;digo del Documento*
              </strong> </div></td>
              ...
              <select name="idTipoDoc">
                <%
                  while (ii.hasNext()) {
                    ...
                    out.println("<option value=" + tipo.getIdTipo() + ">" + tipo.getTipo()+"(Saliente)</option>");
                  }
                  while (iTDIn.hasNext()) {
                    TipoDocVO tipo = (TipoDocVO) iTDIn.next();
                    out.println("<option value=" + tipo.getIdTipo() + ">" + tipo.getTipo()+"(Entrante)</option>");
                  }
        ...
        <tr>
          <td width="120" bgcolor="#ADD8E4"> <div align="right"><strong>Mat.*:</strong>
            </div></td>
          <td> <div align="left">
        ...
        <tr>
          <td width="120" bgcolor="#ADD8E4"> <div align="right"><strong>Fecha
              de Egreso*</strong> </div></td>
          <td> <div align="left">
              <input name="fecha_IO" type="Text" readonly size="15" >
              <a href="javascript:cal3.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date">
              </a> </div></td>
        </tr>
        <tr>
          <td width="120" bgcolor="#ADD8E4"> <p align="right"> <strong>Ant.:</strong>
            </p></td>
          <td> <div align="CENTER">
              <table width="102%" border="0">
                <tr>
                  <td width="56%" rowspan="2"> <input type="hidden" name="idDocAnt"/>
        ...
        <tr>
          <td width="120" bgcolor="#ADD8E4"> <div align="right"><strong>Resumen
              del Documento*</strong> </div></td>
          <td> <div align="left">
              <textarea name="descrip" cols="50" rows="7" wrap="OFF"></textarea>
            </div></td>
        </tr>
        <tr>
  ...
  <tr>
    <td><input type="submit" value="Guardar" name="Submit" onClick="javascript:SelectAllList(document.form1.list1);"/></td>
  </tr>
</table>
<script language="JavaScript" type="text/javascript">
    ...
    frmvalidator.addValidation("plazo","req","Debe indicar el plazo considerado para la ejecución");
    ...
    frmvalidator.addValidation("idTipoDoc","req","Debe indicar el tipo de del documento de la OT");
